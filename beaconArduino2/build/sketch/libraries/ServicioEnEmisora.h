#line 1 "D:\\Personal\\ProyectosUni\\3Anyo\\ProyectoBiometria\\Codigo\\git\\BiometriaYMedioAmbiente-Arduino\\beaconArduino2\\libraries\\ServicioEnEmisora.h"
// ----------------------------------------------------------
...
public:
	...
	public:
		...
		uint16_t escribirDatos(const char *str)
		{
			...
			Serial.print(r);
			Serial.println(" bytes con write() ");
		...
		void activar()
		{
			...
			Serial.print(" (*this).laCaracteristica.begin(); error = ");
			Serial.print(error);
		} // ()
